...
import com.team1.proj.chatoppsett.CHATCLIENT;
import javax.swing.*;
...
public class CHATGUI {
    ...
    public static void Connect(){
        try{
            ...
            System.out.println("Du er tilkoblet til: " + HOST);
    ...
    public static void ConfigureMainWindow(){
        ...
        TA_CONVERSATION.setForeground(new java.awt.Color(0,0,225));
    ...
    public static void ACTION_B_ENTER(){
        if(!TF_UserNameBox.getText().equals("")){
            ...
            CHATSERVER.CurrectUsers.add(UserName);
            MainWindow.setTitle(UserName + "'s Chat Box");
