    ...
    <body>
        ...
        <div id="login">
            ...
            <form:form method="POST" modelAttribute="registreringsForm" action = "RegistrerBruker">
                <form:input type= "email" placeholder="Epost" path="brukerdata.email" /><br>
                <%--<input type="email" placeholder="Epost" /><br>--%>
                <form:input type= "text" placeholder="Navn" path="brukerdata.userName" /><br>
                <center><form:checkbox path="godtarBrukervilkar"/> <form:label path="godtarBrukervilkar" >  Ja, jeg godtar <a href="#">brukervilkårene</a>.</form:label></center><br>
